...
public class TribunalCourtDataProvider {
    ...
    public static Object[][] provideDataExternal5() {
        return new Object[][] {
        	...
        	{"NCDRC","APPEAL EXECUTION(AE)"},
        	{"NCDRC","Appeal Execution Application(AEA)"},
        	{"NCDRC","CCPA Appeal(CCPAA)"},
        	{"NCDRC","EXECUTION REVISION PETITION(ERP)"},
        	{"NCDRC","Execution Application(EA)"},
        	{"NCDRC","First Appeal(FA) / Appeal(A)"},
        	{"NCDRC","Interlocutory Application(IA)"},
        	{"NCDRC","Miscellaneous Application(MA)"},
        	{"NCDRC","Review Application(RA)"},
        	{"NCDRC","Revision Petition(RP)"},
        	{"NCDRC","Second Appeal(SA)"},
        	{"NCDRC","Transfer Application(TA)"},
        	{"NCDRC","Caveat Cases(CV)"},
        	{"NCDRC","Consumer Case(CC)"}
