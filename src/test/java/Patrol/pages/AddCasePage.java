...
//				WaitUtility.waitForElementToBeInvisible(driver, popup_ele);
	...
	public void highCourtByPartyNam(String Court, String CaseStatus, String Year, String PartyName) {
...
//				WaitUtility.waitForElementToBeInvisible(driver, popup_ele);
	...
	public void districtCourtByPartyname(String state, String district) throws IOException {
		File dataFile = new File("District-court-CaseNotFound-data.txt");
