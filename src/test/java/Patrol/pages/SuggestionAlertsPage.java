...
public class SuggestionAlertsPage extends BasePage {
	...
	@FindBy(xpath="//a[contains(text(),'Appeal')]") 
	WebElement appeal;
    ...
    @FindBy(xpath="//a[normalize-space()='Advocate Alert']") 
    WebElement advocateAlert;
   
    @FindBy(xpath="//a[normalize-space()='Users Alert']") 
    WebElement usersAlert;


	@FindBy(xpath = "//a[normalize-space()='Ram']")
	WebElement wipro;
    ...
    @FindBy(xpath="//a[@id='tribunalLink']//div[contains(@class,'position-relative')]")
    WebElement tribunalCourt;
	...
	public void clickOnAppealAlert() {
		appeal.click();
	}
	...
	public void clickOnAdvocateAlert() {
		advocateAlert.click();
	}
	
	public void clickOnUsersAlert() {
		usersAlert.click();
	}
	...
	public void clickOnSupreamcourt() {
		supreameCourt.click();
	}
	...
	public void clickOnTribunalCourt() {
		tribunalCourt.click();
	}
	...
	public void matchCaseNumberAllPages(String pattern) throws InterruptedException {
		...
		while (true) {
			...
			for (int i = 0; i < rows.size(); i++) {
				...
				// Getting row and case link form table
				WebElement row = rows.get(i);
